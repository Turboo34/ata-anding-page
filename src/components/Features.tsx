      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            title="Know what's wrong in minutes"
            description="Upload photos, answer questions, get AI diagnosis instantly—no guesswork, no waiting."
            index={0}
          />
          <FeatureCard
            ...
            description="Background-checked, insured, and rated by other vehicle owners. Every mechanic verified."
            index={1}
          />
          <FeatureCard
            ...
            description="Know the cost in advance with transparent quotes. No hidden fees or surprise charges."
            index={2}
          />
          <FeatureCard
            ...
            description="Repairs at your home, office, or roadside. Service that fits your schedule and location."
            index={3}
          />
        </div>
      </div>
