      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="section-title mb-3 sm:mb-4 opacity-0 fade-in-element">
            Smart Matching, <br className="hidden sm:block" />Trusted Community
          </h2>
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Built by mechanics and drivers, for mechanics and drivers. Experience the difference of a platform designed around trust and transparency.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Our smart algorithm connects you with the right mechanic based on your car's needs, location, and budget preferences."
            index={0}
          />
          <FeatureCard
            ...
            description="See upfront pricing with no hidden fees. Compare quotes from verified mechanics and choose what works for your budget."
            index={1}
          />
          <FeatureCard
            ...
            description="Read honest reviews from real drivers. Every mechanic is verified and rated by the community you can trust."
            index={2}
          />
          <FeatureCard
            ...
            description="All mechanics go through rigorous verification. We ensure every service meets our high standards for quality and reliability."
            index={3}
          />
          <FeatureCard
            ...
            title="24/7 Support"
            description="Get help when you need it most. Our community-driven support connects you with assistance around the clock."
            index={4}
          />
          <FeatureCard
            ...
            description="Book, track, and pay for services right from your phone. Designed for busy drivers who need reliable service on-the-go."
            index={5}
          />
        </div>
      </div>
